...
public class PowConverterTest {
    ...
    public void getter() {
        ...
        Assertions.assertEquals(UnitConverters.identity(), converter.getUnitConverter());
    ...
    public void negate() {
        ...
        Assertions.assertEquals(addConverter, converter.getUnitConverter());
    ...
    public void negativeExponent() {
        ...
        Assertions.assertEquals(addConverter.inverse(), converter.getUnitConverter());
