...
/**
 * Unit test for the {@link Work} quantity.
 */
public class WorkTest extends AbstractTypedQuantityTest<Work, Energy> {

    @Override
    protected Class<Work> getQuantityClass() {
        return Work.class;
    }
    ...
    @Override
    protected BiFunction<Double, Unit<Energy>, Work> getFactoryMethod() {
        return Work::of;
    }

    @Override
    protected Function<Double, Work> getFactoryMethodForSystemUnit() {
        return Work::ofJoule;
    }
