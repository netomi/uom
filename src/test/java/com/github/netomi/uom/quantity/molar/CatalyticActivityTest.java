...
public class CatalyticActivityTest extends AbstractTypedQuantityTest<CatalyticActivity, CatalyticActivity> {
    ...
    @Override
    protected Unit<CatalyticActivity> getSystemUnit() {
        return SI.KATAL.getSystemUnit();
    }

    @Override
    protected BiFunction<Double, Unit<CatalyticActivity>, CatalyticActivity> getFactoryMethod() {
        return CatalyticActivity::of;
    }

    @Override
    protected Function<Double, CatalyticActivity> getFactoryMethodForSystemUnit() {
        return CatalyticActivity::ofKatal;
    }
}
