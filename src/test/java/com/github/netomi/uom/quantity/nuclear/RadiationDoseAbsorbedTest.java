...
public class RadiationDoseAbsorbedTest extends AbstractTypedQuantityTest<RadiationDoseAbsorbed> {
    ...
    protected Class<RadiationDoseAbsorbed> getQuantityClass() {
        return RadiationDoseAbsorbed.class;
    }

    @Override
    protected Unit<RadiationDoseAbsorbed> getSystemUnit() {
        return SI.GRAY.getSystemUnit();
    }

    @Override
    protected BiFunction<Double, Unit<RadiationDoseAbsorbed>, RadiationDoseAbsorbed> getFactoryMethod() {
        return RadiationDoseAbsorbed::of;
    }

    @Override
    protected Function<Double, RadiationDoseAbsorbed> getFactoryMethodForSystemUnit() {
        return RadiationDoseAbsorbed::ofGray;
    }
}
