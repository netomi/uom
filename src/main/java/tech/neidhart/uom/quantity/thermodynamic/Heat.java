...
/**
 * A {@link Quantity} representing a measure of energy in the domain of thermodynamics.
 *
 * @see <a href="https://en.wikipedia.org/wiki/Heat">Wikipedia: Heat</a>
 *
 * @author Thomas Neidhart
 */
public interface Heat extends Energy {

    /**
     * Convenience method to create a {@link Quantity} of type {@link Heat}.
     * <p>
     ...
     * @return a new {@link Heat} instance for the given value.
     */
    static Heat of(double value, Unit<Energy> unit) {
        return Quantities.create(value, unit, Heat.class);
    }

    static Heat ofJoule(double value) {
