...
/**
 * A {@link Quantity} representing a measure of an absorbed dose of radioactivity.
 *
 * @see <a href="https://en.wikipedia.org/wiki/Absorbed_dose">Wikipedia: Absorbed dose</a>
 *
...
public interface RadiationDoseAbsorbed extends TypedQuantity<RadiationDoseAbsorbed, RadiationDoseAbsorbed> {
     ...
     * @return a new {@link RadiationDoseAbsorbed} instance for the given value.
     */
    static RadiationDoseAbsorbed of(double value, Unit<RadiationDoseAbsorbed> unit) {
        return Quantities.create(value, unit, RadiationDoseAbsorbed.class);
    }

    static RadiationDoseAbsorbed ofGray(double value) {
        return of(value, SI.GRAY);
    }

    @Override
    default Unit<RadiationDoseAbsorbed> getSystemUnit() {
        return SI.GRAY.getSystemUnit();
    }
}